...
const float CometBlueBT_MIN_TEMP = 5.0;
const float CometBlueBT_MAX_TEMP = 29.5;
const float CometBlueBT_OFF_TEMP = 4.5;
...
struct DeviceTemp {
  ...
  bool valid() const { return CometBlueBT_OFF_TEMP <= to_user() && to_user() <= CometBlueBT_ON_TEMP; }
